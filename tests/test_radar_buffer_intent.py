...
def test_reordered_motion_is_rejected_even_during_reload_claim(server, generation):
    session = 'buffer-session-12345'
    params = dict(radarSession=[session], radarGeneration=['0'], radarHeartbeat=['1'], radarClaim=[''])
